...
async function liveStats(): Promise<{
  ...
  try {
    ...
    return {
      ...
      schedules: snapshot.workflows.filter((workflow) => workflow.enabled)
        .length,
    ...
    <>
      <section className="l-hero">
        <div className="l-container">
          <h1>
            The treasury that runs <RotatingWord />
          </h1>
          <p>
            AutoKeep turns a DAO treasury strategy into a KeeperHub workflow,
            pays payroll on schedule, and verifies every run onchain. No signer
            babysitting, full audit trail.
          </p>
        ...
        <div className="l-container">
          <Reveal>
            <div className="l-section-head">
              ...
              <p>
                One strategy file, one workflow, one verified payroll run - no
                signer in the loop.
              </p>
            </div>
          </Reveal>
        ...
        <div className="l-container">
          <Reveal>
            <div className="l-section-head">
              ...
              <p>
                Strategy in, onchain execution out. KeeperHub handles the last
                mile.
              </p>
            </div>
          </Reveal>
          ...
          <div className="l-steps">
            <Reveal delay={0}>
              <div className="l-step">
                ...
                <p>
                  A JSON strategy describes who gets paid, how much, and on what
                  schedule.
                </p>
              </div>
            </Reveal>
            <Reveal delay={100}>
              <div className="l-step">
                ...
                <p>
                  AutoKeep compiles it into a KeeperHub workflow with a cron
                  trigger and transfer actions.
                </p>
              </div>
            </Reveal>
            <Reveal delay={200}>
              <div className="l-step">
                ...
                <p>
                  KeeperHub simulates, submits, and retries. AutoKeep verifies
                  the result against intent.
                </p>
              </div>
            </Reveal>
          </div>
      ...
      <section className="l-section">
        <div className="l-container l-cta">
          <Reveal>
            ...
            <p>
              Live balances, schedules, and every onchain execution with
              explorer links.
            </p>
            <a href="/dashboard" className="btn btn-primary">
              Open dashboard
